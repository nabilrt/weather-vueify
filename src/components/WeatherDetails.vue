...
const updatedImageUrl = (imageUrl) => {
  return imageUrl.replace("64x64", "128x128");
};
</script>

<template>
  <div
    className="w-2/3 bg-[#444444] rounded-xl p-8 flex text-white items-center shadow-sm shadow-[#41b883] border-1 border-gray-800"
  >
    ...
    <div className="w-1/3 flex flex-col space-y-4 ">
      <div className="flex flex-col text-center m-auto">
        <img :src="updatedImageUrl(weatherData.condition.icon)" />
